...
IMAGE_NAME="${IMAGE_NAME:-ghcr.io/thrane20/dillinger/runner-vice}"
VERSION="${DILLINGER_RUNNER_VICE_VERSION:-0.1.0}"
...
echo -e "${BLUE}Building VICE Commodore emulator runner: ${IMAGE_NAME}:${IMAGE_TAG}${NC}"
