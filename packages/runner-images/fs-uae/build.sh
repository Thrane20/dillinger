#!/bin/bash
# Build script for FS-UAE runner image
set -e
...
IMAGE_NAME="${IMAGE_NAME:-ghcr.io/thrane20/dillinger/runner-fs-uae}"
VERSION="${DILLINGER_RUNNER_FS_UAE_VERSION:-0.1.0}"
...
echo -e "${BLUE}Building FS-UAE Amiga emulator runner: ${IMAGE_NAME}:${IMAGE_TAG}${NC}"
