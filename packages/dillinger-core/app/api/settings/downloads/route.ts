...
export async function PUT(request: NextRequest) {
  try {
    ...
    const {
      maxConcurrent,
      defaultInstallVolume,
      defaultInstallPath,
      installerCacheMode,
      installerCacheVolumeId,
    ...
    if (autoCheckCompatibilityDatabases !== undefined) {
      updates.autoCheckCompatibilityDatabases = Boolean(autoCheckCompatibilityDatabases);
    }
