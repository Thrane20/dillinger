...
export default function GameScrapePage({ params }: PageProps) {
  ...
  const applyResult = async (result: GameSearchResult) => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/games/${gameId}/scrape/apply`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  return (
    <div className="container mx-auto p-8 max-w-6xl">
      ...
      {hasNoScrapers ? (
        ...
        <>
          <form onSubmit={handleSearch} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mb-8">
                ...
                {searchResults.map((g) => (
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      {g.summary && (
                        <p className="text-sm text-muted line-clamp-3 mb-3">{g.summary}</p>
                      )}
