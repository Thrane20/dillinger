...
import { IGameScraper } from './base-scraper';
import { IGDBScraper } from './igdb-scraper';

export class ScraperManager {
  private scrapers: Map<ScraperType, IGameScraper> = new Map();
  // Settings stored for potential future use in scraper configuration
  // @ts-expect-error - assigned in initialize(), used indirectly
