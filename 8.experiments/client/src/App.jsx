...
import Hero from "./controls/panels/hero/Hero.jsx";
...
import CollectionStats from "./controls/panels/collection/CollectionStats.jsx";
        ...
        <EventProvider>
          ...
          <div className="flex flex-row w-full h-screen gap-4">
            <motion.div
              initial="hidden"
              animate="visible"
              className="flex flex-col w-1/6 gap-4"
            >
              <motion.div
                variants={draw}
                custom={0}
            ...
            <div className="flex flex-col w-1/6 h-full  gap-4">
            ...
            <div className="flex flex-col w-1/2 h-full max-h-full gap-4">
              <div className="flex w-full h-1/5">
                <MasterSearch />
              </div>
              <div className="flex w-full h-3/5 max-h-3/5 double-lined-border">
                <Hero injectedTitle={"Test"} />
              </div>
              <div className="flex w-full h-1/5">
                <Logging />
              </div>
