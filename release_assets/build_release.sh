...
printf "  - dillinger-core:latest\n"
printf "  - dillinger/runner-base:latest\n"
printf "  - dillinger/runner-linux-native:latest\n"
printf "  - dillinger/runner-wine:latest\n"
printf "  - dillinger/runner-vice:latest\n"
printf "  - dillinger/runner-fs-uae:latest\n"
printf "  - dillinger/runner-mame:latest\n"
